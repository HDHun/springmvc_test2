...
<link href="../../../_bootstrap/_bootstrap/bootstrap-5.1.3-dist/css/bootstrap.min.css" rel="stylesheet">
...
<body class="container-fluid">
	...
	<div style="text-align: center; clear: both;">
		<input type="image" src="../../../images/kurly.png" style="width: 150px;">
	</div>
		...
		<div class="container-fluid">
			<div class="row" style="float:none; margin:0 auto;">
					<div class="col-4" style="float:none; margin:0 auto;">
						<input type="text" class="form-control" id="id" placeholder="아이디를 입력해주세요." style="margin:10px; height:55px;">
						<input type="password" class="form-control" id="password" placeholder="비밀번호를 입력해주세요." style="margin:10px; height:55px;">
						...
						<div class="form-check" style="margin-left:10px;">
							  ...
							  <a style="font-size: 12px; margin-left:60%; color: black; text-decoration-line:none;" href="#">아이디찾기 |</a>
							  <a style="font-size: 12px; color: black; text-decoration-line:none;" href="#">비밀번호찾기</a>
						</div>
						<div class="d-grid gap-2" style="margin-left:15px;">
						  <button class="btn btn" style="background-color: purple; color:white; font-weight: bold; height: 50px;" type="button">로그인</button>
...
KURLY CORP. ALL RIGHTS RESERVED</p>
	...
	<script src="../../../_bootstrap/_bootstrap/bootstrap-5.1.3-dist/js/bootstrap.bundle.min.js">
