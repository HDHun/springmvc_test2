...
<!-- 데이터 삭제 -->		
	<button type="submit" class="btn btn-danger" href="javascript:btnModalUelete();" id = "btnModalUelete"data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop1"->
