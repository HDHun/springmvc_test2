...
<form>
	...
	<header style="float: left; width: 55%;" class="d-none d-md-block d-lg-block d-xl-block d-xxl-block">
		...
		<div style="font-weight: bolder; font-size: 30px; margin-top: 15px;">Market
			Service</div>
	</header>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="gy-3 col-12">
					...
					maxlength="20" minlength="4" value="Huun" disabled>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<label for="name" class="form-label">이름</label> <input type="text"
						class="form-control" id="name" value="동훈" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="nameen" class="form-label">이름(영문)</label> <input
						type="text" class="form-control" id="nameen" value="DongHun" disabled>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<label for="firname" class="form-label">성</label> <input
						type="text" class="form-control" id="firname" value="한" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firnameen" class="form-label">성(영문)</label> <input
						type="text" class="form-control" id="firnameen" value="Han" disabled>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<label for="gender" class="form-label">성별</label> <select
						class="form-select" id="gender" disabled>
						<option>선택</option>
				...
				<div class="col-12 col-md-6">
					<label for="birth" class="form-label">생일</label> <input type="text"
						class="form-control" id="birth" value="1996.12.03" disabled>
				</div>
			...
			<div class="row">
				<div class="col">
					<label for="email" class="form-label">이메일</label> <input
						type="text" class="form-control" id="email" disabled
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<label for="sns" class="form-label">SNS</label> <select
						class="form-select" id="sns" disabled>
						<option>선택</option>
				...
				<div class="col-sm-6">
					<label for="fax" class="form-label">FAX</label> <input type="text"
						class="form-control" id="fax" value="024448888" disabled>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<label for="state" class="form-label">거주국가</label> <select
						class="form-select" id="state" disabled>
						<option>선택</option>
				...
				<div class="col-12 col-md-6">
					<label for="recommender" class="form-label">추천인</label> <input
						type="text" class="form-control" id="recommender" disabled>
				</div>
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<label for="changer" class="form-label">최종수정자</label> <input
						type="text" class="form-control" id="changer" value="한동훈" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="changeday" class="form-label">최종수정일</label> <input
						type="text" class="form-control" id="changeday" value="2022-01-01" disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firstchanger" class="form-label">최초등록자</label> <input
						type="text" class="form-control" id="firstchanger" value="2022-01-01"disabled>
				</div>
				<div class="col-12 col-md-6">
					<label for="firstchangeday" class="form-label">최초등록일</label> <input
						type="text" class="form-control" id="fisrtchangeday" value="한동훈"disabled>
				</div>
